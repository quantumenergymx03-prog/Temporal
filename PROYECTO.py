...
,
                ...
                for idx, entry in enumerate(visible, start=1):
                    ...
                    info_column = ft.Column(
                        [
                            ...
                            ft.Text(source_name or "Origen desconocido", size=12, color="#7f8c8d"),
                        ],
                        spacing=2,
                        expand=True,
                    )
                    ...
                    if source_path and os.path.exists(source_path):
                        action_buttons.append(
                            ft.IconButton(
                                ...
                                on_click=lambda e, path=source_path: self._load_file_data(path),
                            )
                        )
                    row = ft.Row(
                        controls=[
    ...
    def _save_fft_trend_snapshot(self, e=None):
